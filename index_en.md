...
| 1.06    | 2.6.2026   | Added chapter 4.8 about use of X-Correlation-ID. |  
...
4. [Query API of the aggregating application](#chapter4)   
  ...
  4.8 [X-correlation-ID header information](#4-8)    
  4.9 [Error management](#4-9)    
  4.10 [Example messages](#4-10)    
...
- errorCode: in case of error, either the error code returned from the datasource or one generated by Aggregating application, see [4.9 Error management](#4-9)  
...
### <a name="4-9"></a> 4.9 Error management
...
### <a name="4-10"></a> 4.10 Example messages
