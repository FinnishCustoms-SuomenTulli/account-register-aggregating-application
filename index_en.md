...
| 1.04    | 29.5.2026  | Added chapter 4.8 about use of X-Correlation-ID. |
...
- errorCode: in case of error, either the error code returned from the datasource or one generated by Aggregating application, see [4.9 Error management](#4-8)  
...
### <a name="4-8"></a> 4.9 Error management
...
### <a name="4-9"></a> 4.10 Example messages
