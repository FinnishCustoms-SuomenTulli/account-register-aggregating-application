...
| 1.06    | 2.6.2026 | Beskrivning på användning av X-correlation-ID har lagts till i avsnitt 4.8. |  
...
4. [Sammanställningsprogrammets frågegränssnitt](#chapter4)   
  ...
  4.9 [Hantering av felsituationer](#4-9)    
  4.10 [Exempelmeddelanden](#4-10)    
...
- errorCode: i händelse av fel, antingen felkoden som returneras från datakällan eller en som genereras av sammanställningsprogrammet, se [4.9 Felhantering](#4-9)
...
### <a name="4-9"></a> 4.9 Hantering av felsituationer
...
### <a name="4-10"></a> 4.10 Exempelmeddelanden
